...
//       <div className="flex animate-marquee items-center whitespace-nowrap gap-10">
//         {/* Apple */}
  ...
  return (
    <div className="w-[90vw] mx-auto h-[40vh] sm:h-[50vh] md:h-[55vh] shadow-lg overflow-hidden rounded-md mb-4 text-[#dee5e5]">
      ...
      <div className="flex animate-marquee items-center whitespace-nowrap gap-10 sm:gap-10">
        {/* Apple */}
        <div className="mx-2 sm:mx-4 md:mx-5 flex items-center text-base sm:text-lg font-semibold">
          <img
            src="https://imgs.search.brave.com/1bhL6ufZamxoV5Ikhs9IXvQoGD4DPumk9Nh2polNLQ8/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly8xMDAw/bG9nb3MubmV0L3dw/LWNvbnRlbnQvdXBs/b2Fkcy8yMDE2LzEw/L0FwcGxlX2xvZ29f/Z3JleS02MjR4NDAw/LnBuZw"
            alt="Apple Logo"
