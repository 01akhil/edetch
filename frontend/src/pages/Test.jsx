...
//        <h1 className='font-bold text-lg tracking-tight'>Psychometric Test</h1>
//        <p className='text-sm'>Indicate your liking about these specific works</p>
//        </div>
...
const Test = () => {
  ...
  return (
    <div>
      <Header className="fixed top-0" />
      <div className="bg-[#FFFFFF] flex flex-col items-center justify-center w-full h-[80vh] text-black">
        <div className="fixed flex flex-col items-center">
          <h1 className="font-bold text-lg tracking-tight">Psychometric Test</h1>
          <p className="text-sm mb-4">
            Indicate your liking about these specific works
          </p>
          <Question
            question={questions[currentQuestionIndex]}
            answerOptions={answerOptions}
